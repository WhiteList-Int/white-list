                    ...
                    {rentals.map((rental) => (
                        <div className="owner-dashboard-card-container">
                            <div className="owner-dashboard-card-container-rental">
                                <img className="owner-dashboard-card-container-rental-img" src={rental.imgs} alt="owned-rental" />
                                <h2>{rental.name}</h2>
                            </div>
                            <div className="owner-dashboard-card-container-left">
                                ...
                                <div className="owner-dashboard-card-container-left-wrapper" id="desc-button-cont" >
                                    ...
                                    <span className="owner-dashboard-card-container-left-wrapper-save" onClick={()=>{setIsOpen(true);}}>
                                        Save Changes
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="owner-dashboard-card-container-remove" onClick={()=>{setIsOpen(true);}}>
                                <span className='owner-dashboard-card-container-remove-button'><h3>Remove Rental Property</h3></span>
                            </div>
                        </div>
                    ))}
                </div>
